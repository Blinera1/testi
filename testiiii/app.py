...
conn = sqlite3.connect('patient registration.sqlite')
cur = conn.cursor()
...
def main():
    ...
    menu = ['Add Patient', 'View Patients', 'Add Doctors','View Doctors']
    ...
    if choice == 'Add Patient':
        ...
        Type_of_visit = st.selectbox('Type of visit', ['urgent', 'Visit'])
        ...
        Birth_date= st.text_input('Date of birth')
        Phone_number = st.text_input('Phone number')
        Specialisation = st.selectbox('Specialisation', ['specialiazed', 'not specialized',])
